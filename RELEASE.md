...
The release workflow can sign and notarize DMGs when Apple Developer credentials are present. Current v0.3.5 website-hosted DMGs are signed with Developer ID, notarized by Apple, stapled, and verified with Gatekeeper assessment.

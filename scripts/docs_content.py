...
app (v0.5.8). Where behaviour is surprising, say so plainly rather than
...
PAGES["index"] = {
    ...
    "lede": "Everything about running OpenVoiceFlow on your Mac — from first launch to the exact bytes that do and don't leave your machine. Written against the shipping app, version 0.5.8.",
    "body": """
        ...
        <p>An honest manual saves you the trouble of looking for something that isn't there. As of 0.5.8:</p>
        <ul>
...
PAGES["updates"] = {
    ...
    "body": """
        ...
        <p>The dashboard sidebar footer shows your version, marked <em>auto-updating</em> when background checks are on. <strong>Settings</strong> shows it too, alongside the manual check button. This documentation describes <strong>0.5.8</strong>.</p>
...
PAGES["faq"] = {
    ...
    "faq": [
        ...
        ("Can I say punctuation out loud?",
         "Not in version 0.5.8 — saying 'comma' produces the word 'comma'. Whisper punctuates from sentence structure automatically, and optional AI cleanup fixes grammar and removes filler words if you want more."),
